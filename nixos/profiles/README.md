...
- **`gateway/`**: Enables the torii-chan gateway role ([`nixos/services/gateway/`](../services/gateway/)) — Nebula Lighthouse/Relay, DDNS, Minecraft port-forward, firewall hardening. See [`hosts/torii-chan/README.md`](../../hosts/torii-chan/README.md) for details.
