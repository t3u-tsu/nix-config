...
- [`backup/`](backup/): Restic backup — sender (`default.nix`) and receiver (`receiver.nix`, currently `kagutsuchi-sama`). See [`backup/README.md`](backup/README.md).
...
- [`gateway/`](gateway/): torii-chan gateway role (`my.services.gateway`) — Nebula Lighthouse/Relay, DDNS, Minecraft port-forward, firewall hardening. See [`gateway/README.md`](gateway/README.md).
